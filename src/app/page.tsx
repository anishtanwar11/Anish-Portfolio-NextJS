  ...
  return (
    <main className="pt-4 lg:pt-0 min-h-screen  antialiased bg-grid-white/[0.02] flex flex-col gap-4">
      ...
      <div className="flex flex-col md:flex-row gap-4 w-full">
        ...
        <div className="w-full flex flex-col gap-6 border-[1px] border-slate-600/20 dark:lg:border-slate-300/20 p-4 rounded-[15px]">
          <h1 className="text-lg text-center font-semibold text-gray-800 dark:text-white py-2 border-b-[1px] border-slate-600/20 dark:lg:border-slate-300/20">LeetCode Solved Questions</h1>
          <LeetCodeCard />
        </div>
      </div>
    </main>
