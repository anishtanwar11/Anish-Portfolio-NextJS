  ...
  const listVariants = {
    ...
    animate: {
      transition: {
        ...
        delayChildren: 0.2, // wait before starting the stagger
      },
    },
  };
      ...
      <AnimatePresence initial={false}>
        {menuOpen && (
          <motion.div
            ...
            className="fixed top-0 left-0 right-0 bottom-0 z-50 backdrop-blur-3xl dark:bg-black/30 shadow-lg"
          >
            <i
              className="ri-close-large-line text-3xl text-white text-right absolute right-6 top-6"
              onClick={toggleMenu}
            ></i>
            <motion.ul
              ...
              animate="animate"
              exit="initial"
              className="md:hidden flex flex-col gap-6 pt-24 pb-4 px-8 w-full h-full text-2xl text-black dark:text-white"
            >
              {[
                {
                  label: "Home",
                ...
                >
                  <Link href={href} onClick={() => setMenuOpen(false)}>
                    <i className={`${icon} text-2xl`}></i> {label}
                  </Link>
                </motion.li>
              ))}
            </motion.ul>
      ...
      <AnimatePresence initial={false}>
        {profileOpen && (
          <motion.div
            ...
            exit={{ y: "100%", opacity: 0 }}
            transition={{ duration: 0.5, ease: "easeInOut" }}
            className="fixed top-0 left-0 right-0 bottom-0 z-[-2] backdrop-blur-3xl dark:bg-black/30 shadow-lg"
          >
